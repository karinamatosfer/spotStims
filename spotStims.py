...
#### STIMULUS DETAILS ####
circ_sizes = [2,3,7,9,12]
circle_center= (-30,92) #-33 (y,x) (-120, x) to test

# static stimulus
static_angle=180
static_velocity=0.0
static_stationary_time=0
static_duration=14
...
for tex in circ_textures:
    ...
    static_circ = stimulus_details.MonocularStimulusDetails(
        ...
        stationary_time=static_stationary_time,
...
new_line = '\n'
to_write = f'### STIM DETAILS ###{new_line}circle_sizes={circ_sizes}{new_line}circle_center={circle_center}{new_line}{new_line}distance_from_fish={distance_from_fish}{new_line}direction={direction}{new_line}### STATIC CIRCLE ###{new_line}static_angle={static_angle}{new_line}static_velocity={static_velocity}{new_line}static_stationary_time={static_stationary_time}{new_line}static_duration={static_duration}{new_line}{new_line}### MOVING CIRCLE ###{new_line}angle={angle}{new_line}velocity={velocity}{new_line}stationary_time={stationary_time}{new_line}duration={duration}'
file.write(to_write)
file.close()
